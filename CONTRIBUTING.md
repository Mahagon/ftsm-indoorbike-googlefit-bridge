...
Development requires Android Studio, JDK 25 (17 minimum), Android SDK Platform 37, and Android SDK Build-Tools 37.0.0. Clone the repository, open it in Android Studio, and allow Gradle sync to finish.
