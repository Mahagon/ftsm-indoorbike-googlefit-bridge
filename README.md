...
See [PRIVACY.md](PRIVACY.md) for how the app handles data, [CONTRIBUTING.md](CONTRIBUTING.md) to contribute, and [SECURITY.md](SECURITY.md) to report a vulnerability privately.
